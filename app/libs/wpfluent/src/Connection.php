<?php namespace FluentGitDb;

use FluentGitDb\Viocon\Container;
...
class Connection
{
    ...
    public function __construct($wpdb, array $config = array(), $alias = null, Container $container = null)
    {
        ...
        $this->eventHandler = $this->container->build('\\FluentGitDb\\EventHandler');
    ...
    {
        class_alias('FluentGitDb\\AliasFacade', $alias);

        $builder = $this->container->build('\\FluentGitDb\\QueryBuilder\\QueryBuilderHandler', array($this));
    ...
    {
        return $this->container->build('\\FluentGitDb\\QueryBuilder\\QueryBuilderHandler', array($this));
    }
