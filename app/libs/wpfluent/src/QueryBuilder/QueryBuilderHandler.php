<?php namespace FluentGitDb\QueryBuilder;

use FluentGitDb\Connection;
use FluentGitDb\Exception;

class QueryBuilderHandler
{

    /**
     * @var \FluentGitDb\Viocon\Container
     */
    protected $container;
    ...
    /**
     * @var \FluentGitDb\QueryBuilder\Adapters\BaseAdapter
     */
    ...
    /**
     * @param null|\FluentGitDb\Connection $connection
     *
     * @throws \FluentGitDb\Exception
     */
    public function __construct(Connection $connection = null)
    {
        ...
        $this->adapterInstance = $this->container->build(
            '\\FluentGitDb\\QueryBuilder\\Adapters\\' . ucfirst($this->adapter),
    ...
    public function query($sql, $bindings = array())
    {
        $this->dbStatement = $this->container->build(
            '\\FluentGitDb\\QueryBuilder\\QueryObject',
            array($sql, $bindings)
        )->getRawSql();
    ...
    public function join($table, $key, $operator = null, $value = null, $type = 'inner')
    {
        ...
        $joinBuilder = $this->container->build('\\FluentGitDb\\QueryBuilder\\JoinBuilder', array($this->connection));
    ...
    public function transaction(\Closure $callback)
    {
        try {
            ...
            $transaction = $this->container->build(
                '\\FluentGitDb\\QueryBuilder\\Transaction',
                array($this->connection)
            );
    ...
    {
        return $this->container->build('\\FluentGitDb\\QueryBuilder\\Raw', array($value, $bindings));
    }
